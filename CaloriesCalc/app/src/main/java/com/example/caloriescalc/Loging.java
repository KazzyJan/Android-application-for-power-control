...
public class Loging extends AppCompatActivity {
    ...
    public static String signedInAccountId;
    ...
    public void onStart() {
        ...
        if (currentUser != null){
            signedInAccountId = currentUser.getUid();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                Log.d(TAG, "firebaseAuthWithGoogle: Email - " + signedInAccountId);
